...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:400,600,700,800,900|Voltaire&display=swap">
    <style>
        * {
        ...
        /* Footer */
        .footer {
            background: #3e1e0e; /* Matches reference dark brown */
            color: #fff;
            margin-top: auto;
        ...
        .footer-center {
            display: flex;
            flex-direction: column;
            align-items: flex-start; /* Align header and links to left */
            margin: 0 auto;
        }
        ...
        .footer-right {
            display: flex;
            flex-direction: column;
            align-items: flex-start; /* Align header and icons to left */
            margin-left: auto;
        }
        .footer-social {
            display: flex;
        ...
        <div class="footer-main">
            ...
            <div class="footer-right">
                ...
                <div class="footer-social">
                    <a href="https://www.instagram.com/kayutanganheritage/" target="_blank" title="Instagram">
